	soc_system u0 (
		...
		.pio_in_enable_export                  (<connected-to-pio_in_enable_export>),                  //                  pio_in_enable.export
		.pio_in_fpga_export                    (<connected-to-pio_in_fpga_export>),                    //                    pio_in_fpga.export
		.pio_in_reset_export                   (<connected-to-pio_in_reset_export>),                   //                   pio_in_reset.export
		.pio_out_busy_export                   (<connected-to-pio_out_busy_export>),                   //                   pio_out_busy.export
		.pio_out_done_export                   (<connected-to-pio_out_done_export>),                   //                   pio_out_done.export
		.pio_out_error_export                  (<connected-to-pio_out_error_export>),                  //                  pio_out_error.export
		.pio_out_fpga_export                   (<connected-to-pio_out_fpga_export>),                   //                   pio_out_fpga.export
		...
		.vga_pixel_enable_export               (<connected-to-vga_pixel_enable_export>),               //               vga_pixel_enable.export
		.vga_pixel_word_export                 (<connected-to-vga_pixel_word_export>),                 //                 vga_pixel_word.export
		.vga_pixel_done_export                 (<connected-to-vga_pixel_done_export>)                  //                 vga_pixel_done.export
	);
